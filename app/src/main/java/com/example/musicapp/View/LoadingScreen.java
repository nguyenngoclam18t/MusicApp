...
public class LoadingScreen extends AppCompatActivity  {
    ...
    public void getSong(@NonNull JsonObject data){
        ...
        for (JsonElement element :arr){
            ...
            ApiCollectionHomePage.arrSongNewRelease.add(new SongModel(encodeId,title,artistsNames,dateString,thumbnailM, duration));
        }
    }
    public void getPlayList(@NonNull JsonObject data, ArrayList<PlaylistModel> modelArrayList) {
        ...
        for (JsonElement element : arr) {
            ...
            for (JsonElement artistElement : artistsArray) {
                ...
                artistsList.add(new ArtistsModel());
            }
            PlaylistModel playlistModel = new PlaylistModel(encodeId, title, thumbnailM, "");
